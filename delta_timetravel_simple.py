# Script auxiliar para testar Delta Lake
# Execute este arquivo dentro do container Spark

from pyspark.sql import SparkSession
from delta.tables import DeltaTable

# Configurações simplificadas - os JARs já estão no classpath
...
print("\n✅ Delta Lake Time Travel concluído com sucesso!")
spark.stop()
